...
import LogoDark from '../../images/Logotip/SVG/1.svg';
import LogoDark1 from '../../images/Logotip/SVG/3.svg';
...
const SignIn: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="rounded-sm min-h-screen border border-stroke bg-white shadow-default">
        <div className="flex flex-wrap items-center max-w-[1280px] mx-auto">
          <div className="hidden w-full lg:block lg:w-1/2 border-r border-stroke">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block w-40" to="/">
          ...
          <div className="w-full border-stroke lg:w-1/2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <a href='/' className="inline font-medium hover:text-primary transition-all duration-200 hover:border-b border-primary">Start for free</a>
              <h2 className="mb-9 text-2xl font-bold text-black sm:text-title-xl2">
                <div className="flex items-center gap-3">
                  <span className='text-strokedark'>Sign In to </span>
                  <Link className="mb-3 inline-block w-28" to="/">
                <img className="" src={LogoDark1} alt="Logo" />
              </Link>
                </div> 
              </h2>
