...
const Products: React.FC = () => {
  ...
  <div key={product._id} className="border rounded-lg p-4 shadow-md bg-white dark:bg-gray-800">
    ...
    <div className="mt-2">
      <span className="text-sm text-gray-500">{`Gender: ${product.gender}`}</span>
    </div>
    ...
    <div className="mt-2">
      <span className="text-sm text-gray-500">{`Store ID: ${product.store}`}</span>
    </div>
    ...
    <div className="mt-2">
      <span className="text-sm text-gray-500">{`Reviews: ${product.reviews.length} review(s)`}</span>
    </div>
