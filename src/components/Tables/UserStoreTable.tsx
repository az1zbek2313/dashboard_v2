...
const UserStoreAdmin: React.FC<TableOneProps> = ({ storeData, onUpdateStore, getData }) => {
  ...
  <div className="mx-auto max-w-screen-lg px-4 2xl:px-0">
    <h2 className="mb-4 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl md:mb-6">{storeData[0] ? storeData[0].name.uz : "My"} store </h2>
      ...
      <div className="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
        <div className="space-y-4">
          <div className="flex space-x-4">
            <img className="h-16 w-16 rounded-lg" src={storeData[0] ? "https://surprize.uz" + storeData[0].image : null} alt="Helene avatar" />
            <div>
              <span className="inline-block rounded bg-primary-100 text-xs font-medium text-primary-800"> My store </span>
              <h2 className="flex items-center text-xl font-bold leading-none text-gray-900 dark:text-white sm:text-2xl">{storeData[0] ? storeData[0].name.uz : "My"} Store</h2>
            </div>
          </div>
          <dl className="">
            <dt className="font-semibold text-gray-900 dark:text-white">My store rating</dt>
            <dd className="text-gray-500 dark:text-gray-400">{storeData[0] ? storeData[0]?.rating : "0"}⭐</dd>
          </dl>
          <dl>
            ...
            <dd className="flex items-center gap-1 text-gray-500 dark:text-gray-400">
              ...
              {storeData[0] ? storeData[0].location : "My location"}
            </dd>
          </dl>
          <dl>
        ...
        <div className="space-y-4">
          <dl>
            ...
            <dd className="text-gray-500 dark:text-gray-400">{storeData[0] ? storeData[0]?.phone : "+1234 567 890 / +12 345 678"}</dd>
          </dl>
          <dl>
            <dt className="font-semibold text-gray-900 dark:text-white">Description</dt>
            <dd className="flex items-center gap-1 text-gray-500 dark:text-gray-400">
              {storeData[0] ? storeData[0]?.description.uz : "+1234 567 890 / +12 345 678"}
            </dd>
          </dl>
          <dl>
            <dt className="font-semibold text-gray-900 dark:text-white">My Companies</dt>
            <dd className="text-gray-500 dark:text-gray-400">{storeData[0] ? storeData[0].name.uz : "My"}, Fiscal code: 18673557</dd>
          </dl>
          <dl>
  ...
  <div id="deleteOrderModal" tabindex="-1" aria-hidden="true" className="fixed left-0 right-0 top-0 z-50 hidden h-modal w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-0 md:h-full">
      <div className="relative h-full w-full max-w-md p-4 md:h-auto">
        ...
        <div className="relative rounded-lg bg-white p-4 text-center shadow dark:bg-gray-800 sm:p-5">
          ...
          <form onSubmit={handleFormSubmit} className="p-5 bg-white dark:bg-gray-800 rounded-md shadow-md">
