...
const UserStoreAdmin: React.FC<TableOneProps> = ({
  storeData,
  onUpdateStore,
  getData,
}) => {
        ...
        <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-8">
          <div className="mx-auto max-w-screen-lg px-4 2xl:px-0">
            <h2 className="mb-4 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl md:mb-6">
              {storeData[0] ? storeData[0].name.uz : 'My'} store{' '}
            </h2>
              ...
              <div className="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
                <div className="space-y-4">
                  <div className="flex space-x-4">
                    <img
                      ...
                      src={
                        storeData[0]
                          ? 'https://surprize.uz' + storeData[0].image
                          : null
                      }
                      alt="Helene avatar"
                    />
                    <div>
                      <span className="inline-block rounded bg-primary-100 text-xs font-medium text-primary-800">
                        {' '}
                        My store{' '}
                      </span>
                  ...
                  <dl className="">
                    ...
                    <dd className="text-gray-500 dark:text-gray-400">
                      {storeData[0] ? storeData[0]?.rating : '0'}⭐
                    </dd>
                  </dl>
                  <dl>
                    <dt className="font-semibold text-gray-900 dark:text-white">
                ...
                <div className="space-y-4">
                  ...
                  <dl>
                    ...
                    <dd className="text-gray-500 dark:text-gray-400">
                      {storeData[0] ? storeData[0].name.uz : 'My'}, Fiscal code:
                      18673557
                    </dd>
                  </dl>
                  <dl>
